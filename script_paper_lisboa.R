...
fig2 = fviz_contrib(res_pca_lisboa_zero, choice = "var", axes = 1, top = 15) + ggtitle("PCA Lisbon", subtitle = "Contributions of variables to PC1 - time 0")
fig3 = fviz_contrib(res_pca_lisboa_zero, choice = "var", axes = 2, top = 15) + ggtitle("PCA Lisbon", subtitle = "Contributions of variables to PC2 - time 0")
...
# Contributions of variables to PC1
fig5 = fviz_contrib(res_pca_lisboa_sete, choice = "var", axes = 1, top = 15) + ggtitle("PCA Lisbon", subtitle = "Contributions of variables to PC1 - time 7")
fig6 = fviz_contrib(res_pca_lisboa_sete, choice = "var", axes = 2, top = 15) + ggtitle("PCA Lisbon", subtitle = "Contributions of variables to PC2 - time 7")
...
# Contributions of variables to PC1
fig8 = fviz_contrib(res_pca_bh_zero, choice = "var", axes = 1, top = 15) + ggtitle("PCA Belo-Horizonte", subtitle = "Contributions of variables to PC1 - time 0")
fig9 = fviz_contrib(res_pca_bh_zero, choice = "var", axes = 2, top = 15) + ggtitle("PCA Belo-Horizonte", subtitle = "Contributions of variables to PC2 - time 0")
...
# Contributions of variables to PC1
fig11 = fviz_contrib(res_pca_bh_sete, choice = "var", axes = 1, top = 15) + ggtitle("PCA Belo-Horizonte", subtitle = "Contributions of variables to PC1 - time 7")
fig12 = fviz_contrib(res_pca_bh_sete, choice = "var", axes = 2, top = 15) + ggtitle("PCA Belo-Horizonte", subtitle = "Contributions of variables to PC2 - time 7")
